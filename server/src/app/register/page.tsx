		...
		<div className="min-h-screen flex items-center justify-center bg-base-200 p-4">
			<div className="w-full max-w-md animate-fade-in">
				...
				<div className="text-center mb-8">
					...
					<h1 className="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Đăng ký tài khoản</h1>
				...
				<div className="card bg-base-100 shadow-xl border border-base-content/10">
					<div className="card-body">
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							...
							<div className="flex flex-col gap-1">
								<label className="label font-medium">Xác nhận Password</label>
								<input
							...
							<button id="register-button" type="submit" className={`btn btn-primary w-full mt-2`} disabled={loading}>
								{loading ? (
